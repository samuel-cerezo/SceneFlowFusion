...
function [delta_p] = delta_dp_ij(i,j,acel_lin,bias_ace,eta_ace,vel_ang,bias_gyr,eta_gyr,delta_t)    %Funcion corroborada OK
    ...
    for k=1:(j-i)
        ...
        delta_p = delta_p + delta_t*delta_dv_ij(1,k,acel_lin,bias_ace,eta_ace,vel_ang,bias_gyr,eta_gyr,delta_t)-(1/2)*deltaRgorro_ij(1,k,vel_ang,bias_gyr,delta_t)*aux_gorro*delta_phi_ij(1,k,vel_ang,bias_gyr,eta_gyr,delta_t)*(delta_t^2) + (1/2)*deltaRgorro_ij(1,k,vel_ang,bias_gyr,delta_t)*eta_ace(:,k)*(delta_t^2);   
    end
end
