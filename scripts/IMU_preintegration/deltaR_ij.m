...
function [delta_R] = deltaR_ij(i,j,vel_ang,bias_gyr,eta_gyr,delta_t)    %Funcion corroborada OK
    ...
    for k=1:(j-i)
        delta_R = delta_R*mapeo_exponencial_SO3((vel_ang(:,k) - bias_gyr(:,k) - eta_gyr(:,k))*delta_t);
    end
...
%el resultado es una matriz de 3x3 formada por vectores ortonormales
