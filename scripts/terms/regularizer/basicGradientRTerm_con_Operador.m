...
classdef basicGradientRTerm_con_Operador < basicDualizedOperator
    methods
        function obj = basicGradientRTerm_con_Operador(alpha,dims,operadorX, operadorY, varargin)
...
% -------------------------------------------- acomodo la matriz de
% operacion de derivada

             operatorList{1}.matrix = operadorX;
             operatorList{2}.matrix = operadorY;
...
%   			obj = obj@basicDualizedOperator(alpha,1,operador,varargin);
